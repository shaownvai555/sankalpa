...
const Signup: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!displayName.trim()) {
      newErrors.displayName = 'নাম লিখুন';
    } else if (displayName.trim().length < 2) {
      newErrors.displayName = 'নাম কমপক্ষে ২ অক্ষরের হতে হবে';
    }
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <span>{loading ? 'অ্যাকাউন্ট তৈরি হচ্ছে...' : t('createAccount')}</span>
          </motion.button>
        </form>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            অ্যাকাউন্ট তৈরি করে আপনি আমাদের শর্তাবলী এবং গোপনীয়তা নীতিতে সম্মত হচ্ছেন।
          </p>
        </div>
      </motion.div>
    </div>
